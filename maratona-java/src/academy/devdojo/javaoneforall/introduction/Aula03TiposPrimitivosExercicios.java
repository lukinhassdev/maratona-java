...
public class Aula03TiposPrimitivosExercicios {
    public static void main(String []args) {
        ...
        // Eu utilizei a concatenação de Strings para criar um template de relatório. Em vez de imprimir valores soltos,
        // eu mesclei textos fixos com variáveis para que o resultado final no terminal seja uma frase completa,
        // organizada e de fácil leitura para o usuário.
